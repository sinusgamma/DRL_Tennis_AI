# DRL Collaboration and Competition
 Deep Reinforcement Learning AI - tennis players
...
![Tennis Environment](https://github.com/sinusgamma/DRL_Tennis_AI/blob/master/tennis.gif)
...
Then, place the file in the p3_tennis_ai folder in the DRLND GitHub repository, and unzip (or decompress) the file.

## Training the AI

The Tennis.ipynb file containes the training code and the test run. Running all the cells will train and save a new model, then calculate a test score with the trained agent.